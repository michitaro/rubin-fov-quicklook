...
from quicklook.utils.fits import preload_afits_compression_code
...
def test_preprocess_ccd_calexp():
    ...
    with timeit('load-fits'):
        ...
        with timeit('preprocess'):
            ppccd = preprocess_ccd(CcdId(visit, 'R01_S00'), io.BytesIO(file_contents))


preload_afits_compression_code()
