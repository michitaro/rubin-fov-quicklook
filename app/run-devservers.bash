...
export QUICKLOOK_s3_repository='{"access_key": "quicklook", "secret": "password", "endpoint": ["192.168.13.201:9000"], "secure": false, "bucket": "quicklook-repository"}'
export QUICKLOOK_s3_tile='{"access_key": "quicklook", "secret": "password", "endpoint": ["192.168.13.201:9000"], "secure": false, "bucket": "quicklook-tile"}'
